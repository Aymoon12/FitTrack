...
const WorkoutLogger = () => {
    ...
    const fetchWorkouts = useCallback(async () => {
        try {
            const response   = await axios.get("http://localhost:8080/api/v1/workout/getAllWorkoutsByDate", {
                params: {
                    user_id: user.id,
                    date: date,
                },
    ...
    const handleDelete = async (id) => {
        ...
        try{
            ...
            const response  = await axios.delete('http://localhost:8080/api/v1/workout/deleteWorkout', {
                params: {
                    workout_id: id,
                },
                headers: {
